...
## Nuevo: modo reporte automatico

La app Streamlit ahora tiene dos flujos:

- `Plan estrategico`: mantiene el generador actual de planes de medios.
- `Reporte automatico`: toma un `PDF`, genera una presentacion con:
  - fondo personalizado en toda la presentacion
  - logo en la esquina superior derecha
  - lectura de metricas y texto legible dentro del PDF
  - opinion cuantitativa automatica
  - diapositiva de comentario ejecutivo
  - diapositiva de pasos a seguir para el mes siguiente

### Consideracion importante para PDFs

La lectura automatica funciona mejor cuando el PDF trae texto seleccionable, tablas o etiquetas numericas embebidas. Si el grafico esta solo como imagen, la extraccion puede quedar parcial y conviene complementar con OCR o datos manuales.

### Branding integrado para reportes

El modo `Reporte automatico` ahora usa por defecto estos assets internos:

- portada: `assets/report-kit/cover-background.png`
- fondo general: `assets/report-kit/slide-background.png`
- logo: `assets/report-kit/logo-prenseable.png`

Ademas, el reporte usa tipografia `Open Sans` con:

- titulares en 16 pt
- texto complementario en 12 pt
